...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addEventListener("scroll", function () {
        if (window.scrollY > 0) {
            header.style = "backdrop-filter: blur(8px);-webkit-backdrop-filter: blur(8px); border: 2px solid #ffffff15; border-radius:150px;margin: 20px auto; transition: .25s; background-image: url('./assets/noise-light.png');background-color: #d5ed9f4f;";
        } else {
